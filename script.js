...
function showProject(type) {
  ...
  card.innerHTML = `<img src="${p.image}" alt="${type} project image" class="w-full rounded-md mb-4">
  ...
  <a href="${p.codeLink}" target="_blank" class="bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-900">View Code</a></div>`;
